...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.algorithm in ['selfkd', 'selfkdaugment', 'selfkdcontrastive', 'pseudolabel_with_anchor']:
        ...
        acc, agr, spec, sens, cac = test_thief(model, model.anchor_model, victim_model, test_loader, ema=False)
    ...
    acc, agr, spec, sens, cac = test_thief(model, model.model, victim_model, test_loader, ema=False)
    ...
    acc, agr, spec, sens, cac = test_thief(model, model.model, victim_model, test_loader, ema=True)
