...
# sys.path.append('/home/ankita/scratch/MSA_Medical/GBCNet/models')
# from models import GbcNet

# sys.path.append('/home/ankita/scratch/MSA_Medical/RadFormer')
...
def get_dataset(args, algorithm, dataset, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True, victim_model=None, labeled_idxs=None, val_idxs=None):
    """
    create dataset
    ...
    # model stealing dataset
    elif dataset == "imagenet32":
        lb_dset, ulb_dset, eval_dset = get_imagenet32(args, algorithm, victim_model, num_labels, num_classes, 
                                                      dataset_root=data_dir, labeled_idxs=labeled_idxs, val_idxs=val_idxs)
        test_dset = None
    elif dataset == "imagenet_full":
        lb_dset, ulb_dset, eval_dset = get_imagenet_full(args, algorithm, victim_model, num_labels, num_classes, 
                                                         dataset_root=data_dir, labeled_idxs=labeled_idxs, val_idxs=val_idxs)
        test_dset = None
    elif dataset == 'GBUSV':
