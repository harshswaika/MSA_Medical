...
def get_config():
    ...
    parser.add_argument('--layer_decay', type=float, default=0.5, help='layer-wise learning rate decay, default to 1.0 which means no layer decay')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    save_path = '/home/deepankar/scratch/MSA_Medical/ssl/saved_models/radformer/selfkd_deit_v8_exp4_3_ur3'
    ...
    pretrained_path = os.path.join(save_path, 'latest_model.pth')
    ...
    print(f'\nBest model on target dataset (without EMA): acc = {acc:.4f}, agreement = {agr:.4f}, spec={spec:.4f}, sens = {sens:.4f}')
    ...
    print(f'Best model on target dataset (with EMA): acc = {acc:.4f}, agreement = {agr:.4f}, spec={spec:.4f}, sens = {sens:.4f}')
