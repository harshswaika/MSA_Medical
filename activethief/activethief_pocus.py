...
if __name__ == "__main__":
    ...
    acc, f1, spec, sens, cac = testz1(target_model, test_loader)
    ...
    for trial in range(cfg.TRIALS):
        ...
        print('Test set stats: mean/std = ', utils.compute_data_stats(dataloaders['test']))
        print('Train set stats: mean/std = ', utils.compute_data_stats(dataloaders['train']))
        print('Val set stats: mean/std = ', utils.compute_data_stats(dataloaders['val']))
        ...
        for cycle in range(cfg.ACTIVE.CYCLES):
            ...
            acc, f1, spec, sens, cac = testz1(thief_model, test_loader)
            ...
            acc, f1, spec, sens, cac = testz1(thief_model, dataloaders['val'])
