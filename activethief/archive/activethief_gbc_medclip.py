...
import utils
# import utilsdfal
from train_utils_gbc_medclip import testz, train_with_validation, train_with_kd, agree, dist
...
if __name__ == "__main__":
    ...
    for trial in range(cfg.RNG_SEED):
        ...
        for cycle in range(cfg.ACTIVE.CYCLES):
            ...
            print(f'Initial model on target dataset: acc = {acc:.4f}, f1 = {f1:.4f}, spec = {spec:.4f}, sens = {sens:.4f}')
            ...
            print(f'Initial model on validation dataset: acc = {acc:.4f}, f1 = {f1:.4f}, spec = {spec:.4f}, sens = {sens:.4f}')
